...
const jsonpesquisa = require('./base1neo4j2.json'); 
//vc ta jogando uma consulta pra uam variavel.
let pesquisa = jsonpesquisa.filter((object) => object.n.identity == 147); 
//aqui vc pesquisa, veja bem vc ta fazendo um filter e passando o identity 147
